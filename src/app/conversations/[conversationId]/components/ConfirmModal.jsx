    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <div className="sm:flex sm:items-start">
                <div className="mx-auto h-12 flex w-12 flex-shrink-0 items-center
                rounded-full justify-center bg-red-100 sm:mx-0 sm:h-10 sm:w-10
                ">
                    <FiAlertTriangle 
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                ...
                <Button disabled={isLoading} onClick={onClose} secondary className="ml-3">Cancel</Button>
            </div>
        </Modal>
    )
}
